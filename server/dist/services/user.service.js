...
exports.getCustomerIds = exports.getAdminAndStaffIds = void 0;
...
const getAdminAndStaffIds = async () => {
    const users = await (0, user_db_1.getAllAdminAndStaff)();
    return users.map(u => u.id);
};
exports.getAdminAndStaffIds = getAdminAndStaffIds;
const getCustomerIds = async () => {
    const users = await (0, user_db_1.getAllCustomer)();
    return users.map(u => u.id);
};
