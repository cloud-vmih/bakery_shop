...
export const emailTemplates = {
    baseTemplate: (content: string, headerText?: string) => `
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
...
`,
    // 1. Template gửi OTP
    sendOTP: (userName: string, otpCode: string, purpose: string = 'đổi mật khẩu') => emailTemplates.baseTemplate(`
...
`, 'Mã xác thực OTP'),
    ...
    verifyEmail: (userName: string, verifyLink: string) => emailTemplates.baseTemplate(`
...
`, 'Xác minh địa chỉ email'),
    ...
    refundFormEmail: (userName: string, orderId: string, refundFormLink: string) => emailTemplates.baseTemplate(`
