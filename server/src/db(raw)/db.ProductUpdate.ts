...
// import {BranchItem} from "../entity/BranchItems"; // Assuming your TypeORM DataSource is exported here
//
// const productRepository = AppDataSource.getRepository(BranchItem);
//
...
//   const updatedData: Partial<BranchItem> = { ...data };
