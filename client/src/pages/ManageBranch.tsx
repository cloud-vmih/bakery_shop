...
export default function BranchPage() {
  ...
  const [selectedBranchForInventory, setSelectedBranchForInventory] = useState<
    number | null
  >(null);
  const { user } = useUser();
  ...
  function BranchModal({ open, onClose, onSubmit, initialData }: ModalProps) {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-emerald-600 mt-2">
                  Manage your bakery branches efficiently
                </p>
              </div>
              <button
                onClick={() => {
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-between items-center mt-3">
              <p className="text-sm text-emerald-600">
                Found{" "}
                <span className="font-semibold">{filteredBranches.length}</span>{" "}
                branch{filteredBranches.length !== 1 ? "es" : ""}
              </p>
