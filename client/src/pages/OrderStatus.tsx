...
//       return "Đơn hàng đang được xử lý yêu cầu hủy";
...
//     if (cancelStatus === "REQUESTED")
//       return "bg-orange-500 cursor-not-allowed opacity-90";
...
//                   "Đơn hàng đang được xử lý yêu cầu hủy"}
//                 {cancelStatus === "APPROVED" &&
//                   "Đơn hàng đã được hủy thành công và đang được hoàn tiền"}
//                 {cancelStatus === "REJECTED" &&
//                   "Yêu cầu hủy đơn hàng đã bị từ chối. Đơn hàng sẽ tiếp tục được xử lý bình thường"}
//               </p>
//               <p className="text-lg text-gray-700 mt-4">
//                 {cancelStatus === "REQUESTED" &&
//                   "Chúng tôi sẽ phản hồi và xử lý hoàn tiền (nếu được chấp thuận) sớm nhất có thể."}
//                 {cancelStatus === "APPROVED" &&
//                   "Số tiền sẽ được hoàn về tài khoản của bạn trong vòng 3-7 ngày làm việc."}
//                 {cancelStatus === "REJECTED" &&
//                   "Bạn có thể theo dõi tiến trình đơn hàng bên dưới."}
//               </p>
//             </div>
//           )}
...
//                   {cancelStatus !== "NONE" && (
//                     <div
//                       className={`w-full px-8 py-4 text-white text-xl font-bold rounded-full text-center ${getCancelButtonClass()}`}
//                     >
//                       {getCancelButtonText()}
//                     </div>
//                   )}
