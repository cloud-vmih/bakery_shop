...
const Home = () => {
  ...
  const promotions: Promotion[] = [
    ...
    },
    {
      ...
      d: "Hàng Thân Thiết",
      discount: "25%",
      image: "/images/chuongtrinh-5.jpg",
    },
    {
      t: "SIÊU KHỦNG 8/3",
      d: "Hoa kem + Trái cây",
      discount: "35%",
      image: "/images/chuongtrinh-6.jpg",
    },
  ];
  ...
  const newsItems: NewsItem[] = [
    {
      ...
      excerpt:
        "Khám phá những mẹo nhỏ để chọn được chiếc bánh kem sinh nhật đẹp mắt và ngon miệng nhất...",
    ...
    },
    {
      ...
      excerpt:
        "Những xu hướng thiết kế bánh kem hot nhất trong năm 2024 mà bạn không thể bỏ lỡ...",
    ...
    },
    {
      ...
      excerpt:
        "Hướng dẫn chi tiết cách làm bánh kem tại nhà với nguyên liệu dễ tìm, đơn giản...",
    ...
    },
    {
      ...
      excerpt:
        "Tìm hiểu về những lợi ích sức khỏe và giá trị dinh dưỡng của bánh kem handmade...",
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="sectionHeader">
              ...
              <p className="sectionSubtitle">
                Khám phá những món bánh được khách hàng yêu thích nhất
              </p>
            </div>
        ...
        <section className="sectionGray">
          <div className="max-w-7xl mx-auto px-4">
            <div className="sectionHeader">
              ...
              <p className="sectionSubtitle">
                Khám phá đa dạng các loại bánh tại cửa hàng chúng tôi
              </p>
            </div>
              ...
              {categories.map((category, index) => {
                ...
                return (
                  <div key={index} className="categoryCard">
                    <div
                      className={`categoryIconWrapper bg-gradient-to-br ${category.color}`}
                    >
        ...
        <section className="sectionGray">
          <div className="max-w-7xl mx-auto px-4 py-16">
            <div className="sectionHeader">
              ...
              <p className="sectionSubtitle">
                Cập nhật xu hướng và kiến thức về bánh ngọt
              </p>
            </div>
