...
// import { orderService, OrderItem } from "../services/orders.service";
...
//       return order.status === "PENDING" && !isOrderCanceled(order);
//     if (activeTab === "confirmed")
//       return order.status === "CONFIRMED" && !isOrderCanceled(order);
...
//                                 (sum, d) =>
//                                   sum +
//                                   (d.itemInfo?.price || 0) * (d.quantity || 1),
//                                 0
//                               )
